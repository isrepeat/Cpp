...
namespace DxSamples {
	SimpleScene::SimpleScene(Microsoft::WRL::ComPtr<H::Dx::ISwapChainPanel> swapChainPanel)
	...
	void SimpleScene::CreateDeviceDependentResources() {
		HRESULT hr = S_OK;
	...
	void SimpleScene::CreateWindowSizeDependentResources() {
	}

	void SimpleScene::ReleaseDeviceDependentResources() {
