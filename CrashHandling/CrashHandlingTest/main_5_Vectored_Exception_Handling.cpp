...
//}
//
//LONG WINAPI VectoredHandlerSkip1(struct _EXCEPTION_POINTERS* ExceptionInfo)
//{
//    PCONTEXT Context;
//
//    Sequence++;
...
//}
//
//LONG WINAPI VectoredHandlerSkip2(struct _EXCEPTION_POINTERS* ExceptionInfo)
//{
//    PCONTEXT Context;
//
//    Sequence++;
...
//}
//
//LONG WINAPI VectoredHandlerSkip3(struct _EXCEPTION_POINTERS* ExceptionInfo)
//{
//    PCONTEXT Context;
//
//    Sequence++;
...
//}
//
//BOOL CheckTest(const char* Variation, PLONG e, PLONG a)
//{
//    int i;
//    BOOL Pass = TRUE;
//
