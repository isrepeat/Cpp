...
void TestGetInfoViaHelpers() {
    std::wcout << L"User name = " << H::GetUserNameW() << std::endl;
    std::wcout << L"Computer name = " << H::GetComputerNameW() << std::endl;
    system("pause");
}

void main() {
    //TestGetInfoViaMSExample();
    TestGetInfoViaHelpers();
    return;
}