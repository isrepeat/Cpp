...
namespace GHelper.Mode
{
    internal class PowerNative
    {
        ...
        public static void SetPowerMode(string scheme)
        {
            ...
            {
                Console.WriteLine("Battery Saver detected");
                return;
            }
            ...
            if (status != 0 || activeScheme != guidScheme)
            {
                ...
                Console.WriteLine("Power Mode " + activeScheme + " -> " + scheme + ":" + (status == 0 ? "OK" : status));
            }
        ...
        public static void SetPowerPlan(string scheme)
        {
            ...
            Console.WriteLine($"Power Plan {activeScheme} -> {scheme} :" + (status == 0 ? "OK" : status));
        }
        ...
        public static void SetLidAction(int action, bool acOnly = false)
        {
            ...
            Console.WriteLine("Changed Lid Action to " + action);
        }
        ...
        public static int GetHibernateAfter()
        {
            ...
            Console.WriteLine("Hibernate after " + seconds);
        ...
        public static void SetHibernateAfter(int minutes)
        {
            ...
            Console.WriteLine("Setting Hibernate after " + seconds + ": " + (hrAC == 0 ? "OK" : hrAC));
        }
        ...
        public static bool GetBatterySaverStatus()
        {
            ...
            {
                Console.WriteLine("Can't check EnergySaverState" + e.Message);
                return false;
            }
        }
