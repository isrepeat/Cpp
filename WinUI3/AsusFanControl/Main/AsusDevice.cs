...
namespace GHelper {
    ...
    static class AsusDevice {
        ...
        public static AsusACPI acpi = new AsusACPI();
        ...
        //    Console.WriteLine("------------");
        //    Console.WriteLine("App launched: " + AppConfig.GetModel() + " :" + Assembly.GetExecutingAssembly().GetName().Version.ToString() + CultureInfo.CurrentUICulture + (ProcessHelper.IsUserAdministrator() ? "." : ""));
        ...
        //        Console.WriteLine("Session:" + e.Reason.ToString());
        ...
        //    Console.WriteLine("AutoSetting for " + isPlugged.ToString());
        ...
        //    Console.WriteLine($"Power Mode {e.Mode}: {SystemInformation.PowerStatus.PowerLineStatus}");
        //    if (e.Mode == PowerModes.Suspend) {
        //        Console.WriteLine("Power Mode Changed:" + e.Mode.ToString());
        ...
        //    if (delay > 0) {
        //        Console.WriteLine($"Charger Delay: {delay}");
        //        Thread.Sleep(delay);
        //    }
        ...
        //            Console.WriteLine($"------- Startup Battery Limit {limit} -------");
        //            acpi = new AsusACPI();
        //            acpi.DeviceSet(AsusACPI.BatteryLimit, limit, "Limit");
        //        }
        //    }
        //    catch (Exception ex) {
        //        Console.WriteLine("Startup Battery Limit Error: " + ex.Message);
        //    }
        //}
