...
public:
#if AvReaderDxgiManager_NEW_LOGIC
    AvReaderDxgiEffect(IMFMediaType* input, DX::DeviceResources* dxDeviceSafeObj, Microsoft::WRL::ComPtr<IMFDXGIDeviceManager> mfDxgiDeviceManager);
#else
    AvReaderDxgiEffect(IMFMediaType* input, DX::DeviceResources* dxDeviceSafeObj);
#endif
    virtual ~AvReaderDxgiEffect();
