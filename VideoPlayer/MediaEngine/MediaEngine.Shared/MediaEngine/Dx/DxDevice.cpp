...
//    ////LOG_DEBUG_D(L"LockDevice [th = ({}) | \"{}\"]", H::GetThreadId(), H::ThreadNameHelper::GetThreadName());
//    HRESULT hr = S_OK;
...
//    //    this->d3dMultithread.Reset();
//    //}
//    ////LOG_DEBUG_D(L"UnlockDevice [th = ({}) | \"{}\"]", H::GetThreadId(), H::ThreadNameHelper::GetThreadName());
//    return hr;
//}
//
//
